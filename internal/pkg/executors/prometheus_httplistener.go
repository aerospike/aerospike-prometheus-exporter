...
func makePromMetric(as statprocessors.AerospikeStat, pLabels ...string) (*prometheus.Desc, prometheus.ValueType) {
	...
	qualifiedName := as.QualifyMetricContext(statprocessors.AEROSPIKE_STAT_SEP_UNDERSCORE) + statprocessors.AEROSPIKE_STAT_SEP_UNDERSCORE + NormalizeMetric(as.Name)
